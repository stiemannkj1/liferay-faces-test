...
public abstract class ApplicantTesterBase extends IntegrationTesterBase {
	...
	public void runApplicantPortletTest_I_FileUpload() {
		...
		// Remove PrimeFaces p:fileUpload transform style since it causes the element to not be displayed according to
		// selenium (although the element is visible to users).
